            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 sm:gap-4">
              {students.length === 0 ? (
                <div className="col-span-full text-center py-12">
                  ...
                  <button
                    onClick={() => {
                      // Extract classId from sessionId API call or pass it as prop
                      const classMatch = sessionDetails?.teacher_class_id;
                      if (classMatch) {
                        window.location.href = `/dashboard/class/${classMatch}`;
                      } else {
