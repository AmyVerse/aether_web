...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen font-[manrope] flex flex-col md:flex-row">
      ...
      <div className="flex w-full md:w-1/2 bg-gradient-to-tl from-gray-700 to-gray-900 flex-col justify-center items-center px-6 md:px-10 py-10 md:py-0">
        <div>
          <h1 className="text-3xl sm:text-4xl font-semibold text-white mb-9">
            Aether:
          </h1>
          <h3 className="text-md sm:text-lg font-normal text-gray-400 tracking-wide">
            An ERP for
          </h3>
          <h2 className="text-4xl sm:text-5xl font-bold text-white leading-tight sm:mb-24">
